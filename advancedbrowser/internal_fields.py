...
class InternalFields:
    ...
    def onBuildContextMenu(self, contextMenu):
        v_str = q("q_Note_internal") 
        nGroup = contextMenu.newSubMenu(f"- {v_str} -")
    ...
    def onAdvBrowserLoad(self, advBrowser):
        ...
        cc = advBrowser.newCustomColumn(
            ...
            onData=lambda c, n, t: {
                0: tr.actions_new(),
                1: tr.scheduling_learning(),
                2: tr.browsing_sidebar_card_state_review(), 
        ...
        def setData(c: Card, value: str):
            try:
                ...
                if value is None:
                    return False
            if not askUser(q("q_Values_may_be_inconsistents")):
                return False
            c.type = value
            c.flush()
            return True
        ...
        cc = advBrowser.newCustomColumn(
            ...
            onData=lambda c, n, t: {
                ...
                1: tr.scheduling_learning(), 
                2: tr.browsing_sidebar_card_state_review(), 
                3: tr.scheduling_learning() + " (" + q("q_days") + ")",
        ...
        def setData(c: Card, value: str):
            try:
                ...
                return False
            if not askUser(q("q_If_the_card_is_not_already_in_a_filtered_deck")):
                return False
            c.odue = value
            c.flush()
            return True
